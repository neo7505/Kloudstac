  ...
  return (
    <>
      <div className="home_page">
        ...
        <div class="my-10 p-4 md:p-10">
          <div>
            <p className="uppercase text-2xl md:text-4xl font-semibold ">
            ...
            <div className="flex flex-col md:flex-row my-10">
              ...
              <div className="basis-full md:basis-3/5 p-2 md:p-5 text-slate-800 text-[16px] md:text-[18px]">
                ...
                <Link
                  to="/register"
                  className="boxed-btn3 bg-[#615CFD] text-white cursor-pointer uppercase text-center text-xs md:text-base font-[400] rounded-3xl py-2 px-8 mt-6"
                >
                  Register
                </Link>
                {/*------------course Faq section ------------------*/}
